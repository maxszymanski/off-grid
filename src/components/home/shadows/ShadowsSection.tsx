    ...
    return (
        <section className="relative z-10">
            <div className="wrapper">
                <div className="relative z-[2] mb-8 flex flex-col items-center px-4 text-center lg:mb-0 xl:px-0">
                ...
                <ShadowCardsBox />
                <div className="z-[5] w-full px-4 lg:absolute lg:bottom-0 lg:left-1/2 lg:-translate-x-1/2 xl:px-0">
